  ...
  if (inputAmount && ProceedToPay) {
    return (
      <div className="flex flex-col items-center w-full">
        ...
        <div className={`mt-2 border rounded-lg p-6 bg-white shadow-md w-full max-w-md transition-all duration-300 ${
          currentTab ? "min-h-[200px] flex flex-col items-center justify-center" : ""
        }`}>
